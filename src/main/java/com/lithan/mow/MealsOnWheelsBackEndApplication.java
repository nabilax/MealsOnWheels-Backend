...
public class MealsOnWheelsBackEndApplication {
	...
	CommandLineRunner initRunner(CustomerRepository customerRepository, PasswordEncoder passwordEncoder,
		...
		return args -> {
			...
			partner.setName("XYM Company");
			partner.setAddress("East Region, Singapore");
			partner.setEmail("xym@gmail.com");
			// partner.setRole(ERole.ROLE_PARTNER);
			partner.setActive(true);
			partner.setPassword(passwordEncoder.encode("123456"));
			...
			member.setName("Nabila");
			member.setAddress("East Region, Singapore");
			member.setGender(EGender.MALE);
			member.setRole(ERole.ROLE_MEMBER);
			member.setEmail("nabila@gmail.com");
			...
			rider.setName("Hewa");
			rider.setAddress("East Region, Singapore");
			rider.setGender(EGender.MALE);
			rider.setRole(ERole.ROLE_RIDER);
			rider.setEmail("hewa@gmail.com");
			...
			volunteer.setName("Hafsa");
			volunteer.setAddress("East Region, Singapore");
			volunteer.setGender(EGender.MALE);
			volunteer.setRole(ERole.ROLE_VOLUNTEER);
			volunteer.setEmail("hafsa@gmail.com");
